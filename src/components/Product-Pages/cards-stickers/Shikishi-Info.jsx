...
const Shikishi = () => {
    ...
    useEffect(() => {
        const logRecentlyViewed = async () => {
            try {
                ...
                if (updError) {
                    console.warn('[Shikishi-Info] recently_viewed update error:', updError);
                }
                ...
                if (insError) {
                    console.warn('[Shikishi-Info] recently_viewed insert error:', insError);
                } else {
                    hasLoggedViewRef.current = true;
                }
            } catch (err) {
                console.warn('[Shikishi-Info] recently_viewed log error:', err);
            }
        };
        logRecentlyViewed();
    ...
    // Build thumbnails: 1) main product image as first thumb, 2) shikishi variants from cards-stickers-images storage, 3) fallbacks
    useEffect(() => {
        let isMounted = true;
        ...
        const buildThumbnails = async () => {
            ...
            // first thumbnail: ensure shikishi.png is always first
            results.push('/cards/shikishi.png');

            // desired variant thumbnails
            const desired = ['shikishi-white', 'shikishi-black', 'shikishi-transparent'];
            ...
            const fallbacks = ['/cards/shikishi.png', '/cards/shikishi-1.png', '/cards/shikishi-2.png', '/logo-icon/logo.png'];
    ...
    useEffect(() => {
        ...
        const fetchReviews = async () => {
            if (!productId) return;
            console.log('[Shikishi-Info] fetching reviews for product:', productId);
            ...
            try {
                ...
                if (!isMounted) return;
                if (error) {
                    console.warn('[Shikishi-Info] reviews query error:', error.message || error);
                    ...
                    console.log('[Shikishi-Info] fetched reviews:', data.length);
                    setReviews(data);
                    ...
                    console.log('[Shikishi-Info] no reviews found');
                    setReviewsAvailable(true);
                    setReviews([]);
                    setReviewsCount(0);
                    setAverageRating(null);
                ...
                console.error('[Shikishi-Info] unexpected error fetching reviews:', err);
                setReviewsAvailable(false);
                setReviews([]);
                setReviewsCount(0);
                setAverageRating(null);
    ...
    const submitReview = async () => {
        ...
        try {
            ...
            console.log('[Shikishi-Info] review submitted successfully');
            // Refresh reviews
            ...
            console.error('[Shikishi-Info] error submitting review:', err);
                ...
                <div className="flex flex-col tablet:flex-row laptop:gap-2 tablet:gap-[50px] phone:p-2 tablet:p-2 justify-center w-full items-stretch">
                    ...
                    <div className="border border-black rounded-md p-6 w-full tablet:w-[601px] h-[732px] flex flex-col overflow-y-auto pr-2">
                        ...
                        <div className="mb-6">
                            ...
                            {techniqueGroup && (
                                <div className="mt-3">
                                    <div className="text-[16px] font-semibold text-gray-700 mb-2">TECHNIQUE FRONT</div>
                ...
                <div className="border border-black rounded-md overflow-hidden">
                    ...
                    >
                        <ul className="text-sm text-gray-700 space-y-2 text-black text-[16px] font-dm-sans">
                            ...
                            <li><p className="m-0 font-normal text-black text-[16px] font-dm-sans">Material: Shikishi Board</p></li>
                            <li><p className="m-0 font-normal text-black text-[16px] font-dm-sans">GSM: 1200 gsm</p></li>
                            <li><p className="m-0 font-normal text-black text-[16px] font-dm-sans">Size: 210x140 mm, 140x140 mm</p></li>
                        ...
                        <div className="px-4 pb-4 tablet:px-6 tablet:pb-6 pt-4">
                            <div className="space-y-3">
                                ...
                                <div>
                                    ...
                                    />
                                    <div className="text-right text-xs text-gray-500 mt-1">{reviewText.length}/300</div>
                                </div>
