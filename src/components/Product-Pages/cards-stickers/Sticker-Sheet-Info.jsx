...
const StickerSheet = () => {
    ...
    useEffect(() => {
        ...
        const fetchReviews = async () => {
            if (!productId) return;
            console.log('[Sticker-Sheet-Info] fetching reviews for product:', productId);
            ...
            try {
                ...
                if (!isMounted) return;
                if (error) {
                    console.warn('[Sticker-Sheet-Info] reviews query error:', error.message || error);
                    ...
                    console.log('[Sticker-Sheet-Info] fetched reviews:', data.length);
                    setReviews(data);
                    ...
                    console.log('[Sticker-Sheet-Info] no reviews found');
                    setReviewsAvailable(true);
                    setReviews([]);
                    setReviewsCount(0);
                    setAverageRating(null);
                ...
                console.error('[Sticker-Sheet-Info] unexpected error fetching reviews:', err);
                setReviewsAvailable(false);
                setReviews([]);
                setReviewsCount(0);
                setAverageRating(null);
    ...
    const submitReview = async () => {
        ...
        try {
            ...
            console.log('[Sticker-Sheet-Info] review submitted successfully');
            // Refresh reviews
            ...
            console.error('[Sticker-Sheet-Info] error submitting review:', err);
    ...
    useEffect(() => {
        const tryHydrateFromNav = () => {
            try {
                ...
                console.debug('[Sticker-Sheet] tryHydrateFromNav failed', e);
            }
            return false;
        };
        ...
        <div className="font-dm-sans w-full bg-cover bg-white phone:pt-[210px] tablet:pt-[220px] laptop:pt-[161px] phone:pb-40 tablet:pb-32 laptop:pb-24 z-0">
            ...
            <div className="max-w-[1200px] mx-auto mt-8 w-full laptop:px-2 phone:p-2 tablet:p-2">
                <div className={`border border-black ${reviews && reviews.length > 0 ? 'border-b-0 rounded-b-none' : ''} rounded-md overflow-hidden`}>
                    ...
                    {reviews && reviews.length > 0 && !isReviewFormOpen && (
                    ...
                    {isReviewFormOpen && (
                        <div className="px-4 pb-4 tablet:px-6 tablet:pb-6 pt-4">
                            ...
                            <div className="w-full mt-5">
                                <hr className="mt-2 border-t border-gray-300" />
                                <div className="flex items-center font-medium gap-2 text-[#111233] text-sm mt-4">
                                    <span>Filter by:</span>
                                    <button
                                        type="button"
                                        onClick={() => setStarFilterRating(0)}
