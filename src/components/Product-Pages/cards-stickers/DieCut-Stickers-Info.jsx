...
const DieCutSticker = () => {
    ...
    // Build thumbnails: 1) main product image as first thumb, 2) diecut-stickers variants from cards-stickers-images storage, 3) fallbacks
    useEffect(() => {
        let isMounted = true;
        ...
        const buildThumbnails = async () => {
            ...
            // first thumbnail: ensure diecut-stickers.png is always first
            results.push('/cards/diecut-stickers.png');

            // desired variant thumbnails
            const desired = ['diecut-stickers-black', 'diecut-stickers-white', 'diecut-stickers-transparent'];
            ...
            const fallbacks = ['/cards/diecut-stickers.png', '/cards/diecut-stickers-1.png', '/cards/diecut-stickers-2.png', '/logo-icon/logo.png'];
    ...
    useEffect(() => {
        ...
        const fetchReviews = async () => {
            ...
            try {
                ...
                if (!isMounted) return;
                if (error) {
                    console.warn('[DieCut-Stickers-Info] reviews query error:', error.message || error);
                ...
                console.error('[DieCut-Stickers-Info] unexpected error fetching reviews:', err);
                setReviewsAvailable(false);
                setReviewsCount(0);
                setAverageRating(null);
                setReviews([]);
    ...
    const submitReview = async () => {
        ...
        try {
            ...
            console.error('[DieCut-Stickers-Info] submit review error:', err);
                ...
                <div className="border border-black rounded-md overflow-hidden">
                    ...
                    >
                        <ul className="text-sm text-gray-700 space-y-2 text-black text-[16px] font-dm-sans">
                            ...
                            <li><p className="m-0 font-normal text-black text-[16px] font-dm-sans">Material: Vinyl</p></li>
                            <li><p className="m-0 font-normal text-black text-[16px] font-dm-sans">GSM: 150 gsm</p></li>
                            <li><p className="m-0 font-normal text-black text-[16px] font-dm-sans">Size: 1 inch, 1.5 inches, 2 inches, 2.5 inches, 3 inches, 3.5 inches, 4 inches</p></li>
