    ...
    useEffect(() => {
        ...
        const tryHydrateFromNav = () => {
            ...
            try {
                ...
                console.debug('Nav hydration failed (ProductBox):', e);
            }
            return false;
        };
                    ...
                    {isReviewFormOpen && (
                        <div className="px-4 pb-4 tablet:px-6 tablet:pb-6 pt-4">
                            ...
                            <div className="flex items-center gap-2 mt-4">
                                <span className="text-sm font-medium text-[#111233]">Filter by:</span>
                                <div className="flex flex-wrap gap-2">
                                    <button
                                        type="button"
                                        onClick={() => setStarFilterRating(0)}
                                        className={`px-3 py-1 text-sm rounded border focus:outline-none focus:ring-0 ${
                                            starFilterRating === 0
                                    ...
                                    {[5, 4, 3, 2, 1].map((rating) => (
                                        <button
                                            ...
                                            type="button"
                                            onClick={() => setStarFilterRating(rating)}
                                            className={`px-3 py-1 text-sm rounded border flex items-center gap-1 focus:outline-none focus:ring-0 ${
                                                starFilterRating === rating
                                                    ? 'bg-gray-200 text-gray-700 border-gray-400'
                                                    : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                                            }`}
                                        >
