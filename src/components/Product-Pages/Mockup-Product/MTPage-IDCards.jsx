    ...
    useEffect(() => {
        ...
        const setBackgroundSide = (side) => {
            const rawUrl = side === 'back'
                ? '/mockup-images/IDCard-Back.png'
                : '/mockup-images/IDCard-Front.png';
            const url = encodeURI(rawUrl);
            window.fabric.Image.fromURL(url, (img) => {
                if (!img) {
                    console.error("Failed to load ID card template image.");
                    return;
                }
            ...
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="w-[420px] ">
                    ...
                    <aside className="w-[120px] flex flex-col items-center gap-3">
                        ...
                        >
                            <img src="/mockup-images/IDCard-Front.png" alt="Front" className="w-full h-24 object-contain" />
                        ...
                        >
                            <img src="/mockup-images/IDCard-Back.png" alt="Back" className="w-full h-24 object-contain" />
                ...
                <div className="fixed left-0 right-0 bottom-0 bg-white border-t shadow-inner">
                    <div className="max-w-[1200px] mx-auto flex items-center justify-between p-4">
                        <div className="flex items-center gap-4">
                            <img src={productImageUrl || "/cards/id-cards.png"} alt="product" className="w-14 h-14 object-cover rounded bg-transparent" onError={(e)=>{ e.currentTarget.src = "/cards/id-cards.png"; }} />
                            <div>
                                <div className="font-semibold text-gray-800">Custom ID Cards</div>
...
export default IDCardsMockupToolPage;
