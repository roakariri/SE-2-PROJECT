...
const TapestryMockupToolPage = () => {
    ...
    const setBackgroundSide = (side) => {
        const url = encodeURI('/mockup-images/Tapestry-Front.png');
        window.fabric.Image.fromURL(url, (img) => {
                if (!img) {
            console.error("Failed to load Tapestry template image.");
                    return;
                }
            ...
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="w-[420px] ">
                    ...
                    <aside className="w-[120px] flex flex-col items-center gap-3">
                        ...
                        >
                            <img src="/mockup-images/Tapestry-Front.png" alt="Front" className="w-full h-24 object-contain" />
                ...
                <div className="fixed left-0 right-0 bottom-0 bg-white border-t shadow-inner">
                    <div className="max-w-[1200px] mx-auto flex items-center justify-between p-4">
                        <div className="flex items-center gap-4">
                            <img src={productImageUrl || "/accessories-images/tapestry.png"} alt="product" className="w-14 h-14 object-cover rounded bg-transparent" onError={(e)=>{ e.currentTarget.src = "/accessories-images/tapestry.png"; }} />
                            <div>
                                <div className="font-semibold text-gray-800">Custom Tapestry</div>
                                
                            </div>
                        </div>

                        <div className="flex items-center gap-4">
                            <button className="px-4 py-2 bg-[#ef7d66] text-black font-semibold rounded" onClick={() => navigate(`/accessories-decorations/tapestry`)}>VIEW PRODUCT</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default TapestryMockupToolPage;