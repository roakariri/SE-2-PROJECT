...
const PhotoCardsMockupToolPage = () => {
    ...
    const setBackgroundSide = (side) => {
        const filename = side === 'back' ? 'PhotoCard-Back.png' : 'PhotoCard-Front.png';
        const url = encodeURI(`/mockup-images/${filename}`);
        window.fabric.Image.fromURL(url, (img) => {
                if (!img) {
            console.error("Failed to load PhotoCard template image.");
                    return;
                }
    ...
    const filename = activeSide === 'back' ? 'PhotoCard-Back.png' : 'PhotoCard-Front.png';
    const url = encodeURI(`/mockup-images/${filename}`);
    window.fabric.Image.fromURL(url, (img) => {
            const imgWidth = img.width || img.naturalWidth || 1;
            const imgHeight = img.height || img.naturalHeight || 1;
            ...
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="w-[420px] ">
                    ...
                    <aside className="w-[120px] flex flex-col items-center gap-3">
                        ...
                        >
                            <img src="/mockup-images/PhotoCard-Front.png" alt="Front" className="w-full h-24 object-contain" />
                        ...
                        >
                            <img src="/mockup-images/PhotoCard-Back.png" alt="Back" className="w-full h-24 object-contain" />
                ...
                <div className="fixed left-0 right-0 bottom-0 bg-white border-t shadow-inner">
                    <div className="max-w-[1200px] mx-auto flex items-center justify-between p-4">
                        <div className="flex items-center gap-4">
                            <img src={productImageUrl || "/cards/photocards.png"} alt="product" className="w-14 h-14 object-cover rounded bg-transparent" onError={(e)=>{ e.currentTarget.src = "/cards/photocards.png"; }} />
                            <div>
                                <div className="font-semibold text-gray-800">Custom Photo Cards</div>
...
export default PhotoCardsMockupToolPage;
