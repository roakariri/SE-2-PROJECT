...
const PhoneHolderMockupToolPage = () => {
    ...
    useEffect(() => {
        ...
        const setBackgroundSide = (side) => {
            const rawUrl = side === 'back'
                ? '/mockup-images/PhoneHolder-Back.png'
                : '/mockup-images/PhoneHolder-Front.png';
            const url = encodeURI(rawUrl);
            window.fabric.Image.fromURL(url, (img) => {
                if (!img) {
                    console.error("Failed to load phone holder template image.");
                    return;
                }
            ...
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="w-[420px] ">
                    ...
                    <main className="flex-1 flex flex-col items-center">
                        <div className="w-full bg-white  p-6 shadow-sm flex items-center justify-center" style={{ height: 520 }}>
                    ...
                    <aside className="w-[120px] flex flex-col items-center gap-3">
                        ...
                        >
                            <img src="/mockup-images/PhoneHolder-Front.png" alt="Front" className="w-full h-24 object-contain" />
                        ...
                        >
                            <img src="/mockup-images/PhoneHolder-Back.png" alt="Back" className="w-full h-24 object-contain" />
                ...
                <div className="fixed left-0 right-0 bottom-0 bg-white border-t shadow-inner">
                    <div className="max-w-[1200px] mx-auto flex items-center justify-between p-4">
                        <div className="flex items-center gap-4">
                            <img src={productImageUrl || "/accessories-images/phone-holder.png"} alt="product" className="w-14 h-14 object-cover rounded bg-transparent" onError={(e)=>{ e.currentTarget.src = "/accessories-images/phone-holder.png"; }} />
                            <div>
                                <div className="font-semibold text-gray-800">Custom Phone Holder</div>
...
export default PhoneHolderMockupToolPage;