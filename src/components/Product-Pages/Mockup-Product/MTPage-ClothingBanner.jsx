...
const ClothingBannerMockupToolPage = () => {
    ...
    useEffect(() => {
        ...
        const setBackgroundSide = (side) => {
            const rawUrl = side === 'back'
                ? '/mockup-images/Clothing Banner-Back.png'
                : '/mockup-images/Clothing Banner-Front.png';
            const url = encodeURI(rawUrl);
            window.fabric.Image.fromURL(url, (img) => {
                if (!img) {
                    console.error("Failed to load clothing banner template image.");
                    return;
                }
            ...
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="w-[420px] ">
                    ...
                    <aside className="w-[120px] flex flex-col items-center gap-3">
                        ...
                        >
                            <img src="/mockup-images/Clothing Banner-Front.png" alt="Front" className="w-full h-24 object-contain" />
                        ...
                        >
                            <img src="/mockup-images/Clothing Banner-Back.png" alt="Back" className="w-full h-24 object-contain" />
                ...
                <div className="fixed left-0 right-0 bottom-0 bg-white border-t shadow-inner">
                    <div className="max-w-[1200px] mx-auto flex items-center justify-between p-4">
                        <div className="flex items-center gap-4">
                            <img src={productImageUrl || "/signages-posters/clothing-banner.png"} alt="product" className="w-14 h-14 object-cover rounded bg-transparent" onError={(e)=>{ e.currentTarget.src = "/signages-posters/clothing-banner.png"; }} />
                            <div>
                                <div className="font-semibold text-gray-800">Custom Clothing Banner</div>
...
export default ClothingBannerMockupToolPage;
